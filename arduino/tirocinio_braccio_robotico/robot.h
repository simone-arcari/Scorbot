...
bool Robot::chekPosition(point_t pos) {
  ...
  if (type == true) {
    return (pos.x1 >= minPoints.x1 && pos.x1 <= maxPoints.x1) && (pos.x2 >= minPoints.x2 && pos.x2 <= maxPoints.x2) && (pos.x3 >= minPoints.x3 && pos.x3 <= maxPoints.x3) && (pos.x4 >= minPoints.x4 && pos.x4 <= maxPoints.x4) && (pos.x5 >= minPoints.x5 && pos.x5 <= maxPoints.x5) && (pos.x6 >= minPoints.x6 && pos.x6 <= maxPoints.x6);
  } else {
